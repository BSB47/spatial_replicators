...
namespace Para {
inline constexpr int sys_nrow{500};
inline constexpr int sys_ncol{500};
...
inline constexpr double diffusion_probability{1};
inline constexpr double mutation_probability{1};
